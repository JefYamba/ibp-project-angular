...
export function getAllMessagesForAdmins(http: HttpClient, rootUrl: string, params?: GetAllMessagesForAdmins$Params, context?: HttpContext): Observable<StrictHttpResponse<ResponseDto>> {
