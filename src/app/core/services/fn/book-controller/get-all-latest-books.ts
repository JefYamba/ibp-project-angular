...
export function getAllLatestBooks(http: HttpClient, rootUrl: string, params?: GetAllLatestBooks$Params, context?: HttpContext): Observable<StrictHttpResponse<ResponseDto>> {
