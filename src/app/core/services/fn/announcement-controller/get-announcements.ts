...
export function getAnnouncements(http: HttpClient, rootUrl: string, params?: GetAnnouncements$Params, context?: HttpContext): Observable<StrictHttpResponse<ResponseDto>> {
